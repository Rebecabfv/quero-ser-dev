// Permita a um usuário jogar até 4 dados simultâneos que tenham de 4, 6, 8, 10, 12 ou 20 e
// retorne o valor total do número obtido da seguinte forma:
...
for (let i = 1; i <= numeroDeDados; i++) {
  ...
  const primeiroDado = Math.floor(Math.random() * dadosSorteados + 1);
  console.log(
    'Valor sorteado do ' +
      i +
      'º dado de ' +
